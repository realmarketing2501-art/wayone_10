...
const features = [
  {
    ...
    desc: 'Fino al 5% al giorno con piani di investimento flessibili e trasparenti.',
  },
  {
    icon: Users,
...
const levels = [
  ...
  { name: 'Silver Elite', rate: '3.0%', color: 'from-slate-400 to-slate-300' },
  { name: 'Gold', rate: '4.0%', color: 'from-yellow-500 to-amber-400' },
  { name: 'Diamante', rate: '5.0%', color: 'from-purple-500 to-violet-400' },
];
        ...
        <div className="relative mx-auto max-w-5xl px-4 pb-16 pt-12 sm:pt-20 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-4 max-w-lg text-base text-muted-foreground sm:text-lg">
              Rendimenti giornalieri fino al 5%. Costruisci la tua rete, sblocca livelli superiori 
          ...
          >
            {[
              { value: '5%', label: 'Max giornaliero' },
              { value: '5', label: 'Livelli' },
